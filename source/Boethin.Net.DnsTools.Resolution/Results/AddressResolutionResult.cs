/*
 * File: Boethin.Net.DnsTools.Resolution/Results/AddressResolutionResult.cs
 *
...
{
  public class AddressResolutionResult : ResolutionResult
  {

    public IEnumerable<DnsClient.DNS.Records.Address> Addresses { get; internal set; }
